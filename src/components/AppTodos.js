    ...
    return (
      <div className='comment'>
        <div className='content'>
          <span className='author' style={styles.title} onClick={this.handleChangeComplete.bind(this)}>{this.props.text}</span>
          ...
          <span className='ui blue button' style={styles.delete} onClick={this.handleDelete.bind(this)}>删除</span>  
        </div>
      </div>
    )
  }
